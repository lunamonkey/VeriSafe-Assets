...
function reBuildAssets() {
	...
	console.log("VeriSafe Assets: About to reassign allAssets from settingsAssets.tokens.");
	Object.assign(allAssets, settingsAssets.tokens);
	// put the contents of coins, directly into assets (no parent container)
	console.log("VeriSafe Assets: About to reassign allAssets from settingsAssets.coins.");
